    ...
    <div class="content">
      ...
      <div class="sliders">
        <el-carousel :interval="5000" arrow="always" height="460px">
          <el-carousel-item>
            <img
              src="https://oss.xuexiluxian.cn/xiaoluxian-vcr/c25b24f205c8405e9b1a6161074c6488.jpg"
            />
          </el-carousel-item>
          <el-carousel-item>
            <img
...
// api文件
import { getFirstCategorys, tagsList } from "../../utils/api/courseManager";
...
//   console.log(getFirstCategorys.value);
});
...
tagsList(tagsList).then((res) => {
  console.log(res);
});

// 鼠标移入
const mourseHover = (index) => {
  isFirst.value = true;
  console.log(index);
};
// 鼠标移出
const mourseOut = (index) => {
  isFirst.value = false;
};
</script>
